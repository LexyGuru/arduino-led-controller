# Arduino LED Controller 5.6.1-beta.2

## Release identity

- Application: `5.6.1-beta.2`
...
- The running `5.6.1-beta.2` build always identifies itself as a Beta build.
...
1. Launch the released `5.6.1-beta.2` application.
...
## Beta.2 Device Key transport recovery
