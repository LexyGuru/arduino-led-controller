...
- Direct API: `1.0.0`
- Release notes: `docs/v5/V58_STABLE_RELEASE_NOTES.md`
- Installation guide: `docs/v5/V58_STABLE_INSTALLATION_GUIDE.md`
- Release checklist: `docs/v5/V58_STABLE_RELEASE_CHECKLIST.md`
