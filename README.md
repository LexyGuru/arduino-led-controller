...
> **Jelenlegi fejlesztési kiadás: Arduino LED Controller V5.6 Beta.2**
...
- [Részletes gyökér release notes](RELEASE_NOTES_5.6.1-beta.2.md)
...
```text
                ...
                ▼                                               ▼
┌───────────────────────────────┐             ┌────────────────────────────────┐
│ Tauri V5.6 Beta.2 client      │             │ Debian 13 Rust LXC             │
│                               │             │                                │
