...
export function FirmwarePage({
  ...
  return (
    <div className="page visual31-management-page visual31-firmware-page v55-firmware-page beta4-firmware-redesign core-v3-management-page core-v3-firmware-page" data-core-management="firmware">

      <section className="visual31-management-hero visual31-firmware-command" data-visual31-management="firmware">
        <div className="visual31-management-hero__copy">
          <p className="eyebrow">{t('visual31.firmware.eyebrow')}</p>
          <h3>{t('visual31.firmware.title')}</h3>
          <p className="muted">{t('visual31.firmware.currentLine', { version: firmware?.installedVersion ?? '—', channel: selectedFirmwareChannel.toUpperCase() })}</p>
        </div>
