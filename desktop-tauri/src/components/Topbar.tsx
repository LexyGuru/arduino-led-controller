...
import { CircleDot, Clock3, Cpu, RefreshCw, Wifi, WifiOff } from 'lucide-react';
import { useI18n } from '../i18n';
export function Topbar({ online, deviceLabel, firmwareVersion, timeSynced, message, busy, onRefresh }: {
    online: boolean;
    deviceLabel: string;
    ...
    const { t } = useI18n();
    return (<header className="topbar core-topbar core-v3-topbar">
      <div className="core-topbar-copy">
        ...
        <p className="topbar-tagline"><I18nText k="legacyUi.direct.arduino.control.automation.9ca2eb00"/></p>
      </div>
      ...
      <div className="core-topbar-actions visual31-topbar-hud">
        ...
        <button type="button" className="secondary core-refresh-button" onClick={onRefresh} disabled={busy} aria-label={t('common.refresh')}>
