...
export function V5FirmwareBackups({
  backups,
  busy,
  apiAvailable,
  onRollback,
    ...
    <section className="panel v5-firmware-backups">
      ...
      {!apiAvailable && (
        <p className="console-warning">
          A backup és rollback funkciókhoz hitelesített API v2
          kapcsolat szükséges.
        </p>
      )}
              ...
              <div className="v5-row-actions">
                <button
                  ...
                  onClick={() => {
                    if (
                      globalThis.confirm(
                        'Biztosan visszaállítod ezt a firmware backupot?'
                      )
                    ) {
                ...
                <button
                  ...
                  onClick={() => {
                    if (
                      globalThis.confirm(
                        'Biztosan törlöd ezt a firmware backupot?'
                      )
                    ) {
                      onDelete(backup.id);
                    }
