...
assert.match(logs, /@tauri-apps\/plugin-dialog/);
assert.match(logs, /write_export_file/);
assert.match(logs, /localizeAuditMessage/);
assert.match(logs, /localizeNetworkMessage/);
assert.doesNotMatch(logs, /URL\.createObjectURL/);
assert.doesNotMatch(logs, /document\.createElement\(['"]a['"]\)/);
