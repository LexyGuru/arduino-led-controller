...
required_files=(
  ...
  "desktop-tauri/src/services/v5ArduinoModels.d.mts"
  "desktop-tauri/src/services/v5LedModels.mjs"
  "desktop-tauri/src/services/v5LedModels.d.mts"
  "desktop-tauri/src/hooks/useV5Dashboard.ts"
  "desktop-tauri/src/hooks/useV5Leds.ts"
  "desktop-tauri/src/components/v5/V5DataSourceBadge.tsx"
  "desktop-tauri/src/components/v5/V5ConnectionWarning.tsx"
  "desktop-tauri/src/components/v5/V5LedBulkActions.tsx"
  ...
  "scripts/test-desktop-dashboard-led-models.js"
  "scripts/test-desktop-arduino-led-domains.js"
  "scripts/test-desktop-dashboard-led-ui-contract.js"
  "scripts/test-desktop-dashboard-led-generated-compat.js"
  "scripts/test-desktop-dashboard-led-api-v2-manifest.js"
  "docs/v5/DESKTOP_DASHBOARD_LED_API_V2.md"
  ...
  "desktop-tauri/src/components/v5/V5LogToolbar.tsx"
  "desktop-tauri/src/components/v5/V5ScheduleConflict.tsx"
  "desktop-tauri/src/components/v5/V5ScheduleState.tsx"
  ...
  "desktop-tauri/src/services/v5FirmwareModels.d.mts"
  "desktop-tauri/src/services/v5FirmwareModels.mjs"
  "desktop-tauri/src/services/v5LogModels.d.mts"
  "desktop-tauri/src/services/v5LogModels.mjs"
  "desktop-tauri/src/services/v5ScheduleModels.d.mts"
  "desktop-tauri/src/services/v5ScheduleModels.mjs"
  "docs/v5/DESKTOP_SCHEDULE_FIRMWARE_LOGS_API_V2.md"
  "docs/v5/PACKAGE_MANIFEST_DESKTOP_SCHEDULE_FIRMWARE_LOGS_API_V2.json"
  "scripts/test-desktop-schedule-firmware-log-domains.js"
  "scripts/test-desktop-schedule-firmware-log-generated-compat.js"
  "scripts/test-desktop-schedule-firmware-log-models.js"
  "scripts/test-desktop-schedule-firmware-log-ui-contract.js"
  "scripts/test-desktop-schedule-firmware-logs-manifest.js"
  ...
  "scripts/verify-release-gate-report.js"
  "scripts/verify-alpha2-promotion-readiness.js"
  "scripts/test-release-gate-report.js"
  "scripts/test-release-gate-service.js"
  "scripts/test-release-gate-runtime-wiring.js"
  "docs/v5/RELEASE_GATE_RUNTIME_WIRING_HOTFIX.md"
  "scripts/test-release-routes.js"
  "scripts/test-alpha2-release-tooling.js"
  "scripts/test-desktop-release-gate-models.js"
  "scripts/test-desktop-release-gate-domain.js"
  "scripts/test-desktop-release-gate-ui.js"
  "scripts/test-alpha2-release-infrastructure-manifest.js"
  "desktop-tauri/src/services/v5ReleaseGateModels.mjs"
  "desktop-tauri/src/services/v5ReleaseGateModels.d.mts"
  "desktop-tauri/src/components/v5/V5ReleaseGatePanel.tsx"
  "docs/v5/ALPHA2_RELEASE_GATE_RUNBOOK.md"
  ...
  "scripts/generate-release-provenance.js"
  "scripts/scan-release-secrets.js"
  "scripts/build-alpha2-release-evidence.js"
  "scripts/verify-alpha2-release-evidence.js"
  ...
  ".releaseignore"
  "docs/v5/ALPHA2_RELEASE_EVIDENCE_CHAIN.md"
  "docs/v5/ALPHA2_STAGING_PROMOTION_RUNBOOK.md"
  "scripts/test-release-sbom.js"
  "scripts/test-release-provenance.js"
  "scripts/test-release-secret-scanner.js"
  "scripts/test-alpha2-release-evidence.js"
  "scripts/test-alpha2-evidence-tooling.js"
  "scripts/test-alpha2-release-evidence-manifest.js"
  ...
  "scripts/verify-alpha2-execution-receipts.js"
  "desktop-tauri/src/services/v5ReleaseExecutionModels.mjs"
  "desktop-tauri/src/services/v5ReleaseExecutionModels.d.mts"
  "desktop-tauri/src/components/v5/V5ReleaseFinalizationPanel.tsx"
  "desktop-tauri/src/release-finalization.css"
  "docs/v5/ALPHA2_EXECUTION_RECEIPT_CHAIN.md"
  "docs/v5/ALPHA2_FINALIZATION_RUNBOOK.md"
  "scripts/test-release-execution-receipt.js"
  "scripts/test-release-finalization-service.js"
  "scripts/test-release-finalization-runtime-wiring.js"
  "scripts/test-release-finalization-routes.js"
  "scripts/test-alpha2-execution-tooling.js"
  "scripts/test-desktop-release-finalization-models.js"
  "scripts/test-desktop-release-finalization-ui.js"
  "scripts/test-alpha2-finalization-generated.js"
  "scripts/test-alpha2-execution-finalization-manifest.js"
  ...
  "scripts/update-alpha2-orchestration-state.js"
  "scripts/build-alpha2-artifact-index.js"
  ...
  "desktop-tauri/src/services/v5LxcOrchestrationModels.d.mts"
  "desktop-tauri/src/components/v5/V5LxcOrchestrationPanel.tsx"
  "desktop-tauri/src/lxc-orchestration.css"
  "docs/v5/ALPHA2_LXC_ORCHESTRATOR.md"
  "docs/v5/ALPHA2_LXC_ORCHESTRATOR_RUNBOOK.md"
  "docs/v5/PACKAGE_MANIFEST_ALPHA2_LXC_ORCHESTRATOR.json"
  "scripts/test-alpha2-orchestration-state.js"
  "scripts/test-alpha2-orchestration-service.js"
  "scripts/test-alpha2-orchestration-runtime-wiring.js"
  "scripts/test-alpha2-orchestration-routes.js"
  "scripts/test-alpha2-orchestration-tooling.js"
  "scripts/test-alpha2-production-guard.js"
  "scripts/test-desktop-lxc-orchestration-models.js"
