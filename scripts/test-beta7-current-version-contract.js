...
assert.equal(pkg.version,"5.5.0-beta.1");
assert.ok(fw.includes('#define FIRMWARE_VERSION "5.0.0-beta.7"'));
assert.ok(fw.includes('#define DIRECT_API_VERSION "1.0.0"'));
assert.ok(readme.includes('| Alkalmazás | `5.5.0-beta.1` |'));
assert.ok(readme.includes('| Firmware | `5.0.0-beta.7` |'));
assert.ok(state.includes('`5.5.0-beta.1`')&&state.includes('`5.0.0-beta.7`')&&state.includes('`1.0.0`'));
console.log("OK: app 5.5.0-beta.1, firmware 5.0.0-beta.7, Direct API 1.0.0");
