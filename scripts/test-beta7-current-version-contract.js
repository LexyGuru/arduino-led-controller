...
assert.ok(state.includes('`5.0.0-beta.7`')&&state.includes('`5.0.0-beta.6`')&&state.includes('`1.0.0`'));
console.log("OK: app 5.0.0-beta.7, firmware 5.0.0-beta.6, Direct API 1.0.0");
