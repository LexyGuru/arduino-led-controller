...
assert.equal(rootPackage.version, '5.5.0-beta.3'); assert.equal(desktopPackage.version, '5.5.0-beta.3');
assert.equal(versions.application, '5.5.0-beta.3'); assert.equal(versions.firmware, '5.0.0-beta.8'); assert.equal(versions.directApi, '1.0.0');
