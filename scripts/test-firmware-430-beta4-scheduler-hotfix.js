...
assert.match(ino, /#define FIRMWARE_VERSION "4\.3\.0-beta\.4"/);
assert.equal(release.firmwareVersion,'4.3.0-beta.4');
...
console.log('OK: firmware 4.3.0-beta.4 NTP/scheduler/manual-override hotfix contract');
