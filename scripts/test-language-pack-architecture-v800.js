...
assert.equal(release.application,'6.0.0-beta.1');
assert.equal(release.applicationRelease.version,'6.0.0-beta.1');
assert.equal(release.firmware,'5.1.0-beta.3');
assert.equal(release.directApi,'1.1.0');
assert.ok(stagingEnv.includes('RELEASE_TARGET_VERSION=6.0.0-beta.1'));
...
console.log('V804J_VERSION_6_0_0_BETA_1=PASSED');
