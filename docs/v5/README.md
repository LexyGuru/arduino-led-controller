...
A korábbi Alpha/F14 patch-manifestek és egyszer használatos runbookok eltávolításra kerültek. Történeti összefoglaló: [`docs/history/V5_ALPHA_HISTORY.md`](../history/V5_ALPHA_HISTORY.md).
