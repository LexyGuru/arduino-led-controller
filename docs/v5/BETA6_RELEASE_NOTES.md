...
A Beta.6 alkalmazáskiadás a teljes magyar, angol és német felületet, a központi runtime-üzenetréteget és a kiadási dokumentáció egységesítését tartalmazza.

Az alkalmazás binárisverziója továbbra is `5.0.0-beta.6`. A hozzá tartozó, jelenleg ajánlott Beta firmware időközben `4.3.0-beta.6` verzióra frissült, és külön, az `Arduino_LED_Controller_Firmware_BETA` prerelease-ben érhető el.
...
- Beta.6 telepítési útmutató és release checklist.
