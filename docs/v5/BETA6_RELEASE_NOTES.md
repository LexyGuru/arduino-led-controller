# Arduino LED Controller 5.0.0-beta.6

## Multilingual Desktop Stabilization Release

A Beta.6 a teljes magyar, angol és német felületet, a központi runtime-üzenetréteget és a kiadási dokumentáció egységesítését szállítja. A firmware és a Direct API protokoll változatlan marad.
...
- új Beta.6 telepítési útmutató és release checklist.
...
A Beta.6 kizárólag a beta csatornán jelenik meg. A firmware-katalógus nem használ stabil fallbacket beta csatornán.
...
## Firmware-katalógus és kiadási workflow javítás

- A firmware-kártyák címe egyértelműen `Firmware <verzió>` formátumú.
- Az azonos firmware-verziót használó alkalmazáskiadások egyetlen kártyába kerülnek.
