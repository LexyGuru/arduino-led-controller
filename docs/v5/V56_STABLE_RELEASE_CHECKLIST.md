# Arduino LED Controller 5.6.1 — release checklist

## Identity and branch

- [ ] `VERSION` is `5.6.1`
- [ ] application/package/Tauri/LXC versions are synchronized to `5.6.1`
- [ ] `release-versions.json` application channel is Beta and branch is `next/v5-rearchitecture`
- [ ] firmware remains `5.0.0`
