# Arduino LED Controller 5.6.1-beta.2 — installation guide

## Release identity

- Application: `5.6.1-beta.2` (Beta)
...
Use the assets attached to the `5.6.1-beta.2` GitHub prerelease.
...
A running `5.6.1-beta.2` binary remains a Beta build even while it checks the Stable channel.
...
1. Confirm the application reports `5.6.1-beta.2` and Beta build identity.
...
## Beta.2 Device Key verification
